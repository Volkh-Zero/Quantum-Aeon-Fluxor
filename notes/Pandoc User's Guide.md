...
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --html-q-tags                    | ::: {#cb122 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | html-q-tags: true                 |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --ascii                          | ::: {#cb124 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | ascii: true                       |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --reference-links                | ::: {#cb126 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | reference-links: true             |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --reference-location block       | ::: {#cb128 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | reference-location: block         |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --figure-caption-position=above  | ::: {#cb130 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | figure-caption-position: above    |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --table-caption-position=below   | ::: {#cb132 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | table-caption-position: below     |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --markdown-headings atx          | ::: {#cb134 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | markdown-headings: atx            |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --list-tables                    | ::: {#cb136 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | list-tables: true                 |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --top-level-division chapter     | ::: {#cb138 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | top-level-division: chapter       |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --number-sections                | ::: {#cb140 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | number-sections: true             |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --number-offset=1,4              | ::: {#cb142 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | number-offset: \[1,4\]            |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --listings                       | ::: {#cb144 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | listings: true                    |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --list-of-figures                | ::: {#cb146 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | list-of-figures: true             |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --lof                            | ::: {#cb148 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | lof: true                         |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --list-of-tables                 | ::: {#cb150 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | list-of-tables: true              |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --lot                            | ::: {#cb152 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | lot: true                         |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --incremental                    | ::: {#cb154 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | incremental: true                 |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --slide-level 2                  | ::: {#cb156 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | slide-level: 2                    |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --section-divs                   | ::: {#cb158 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | section-divs: true                |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --email-obfuscation references   | ::: {#cb160 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | email-obfuscation: references     |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --id-prefix ch1                  | ::: {#cb162 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | identifier-prefix: ch1            |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --title-prefix MySite            | ::: {#cb164 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | title-prefix: MySite              |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --css styles/screen.css  \       | ::: {#cb166 .sourceCode}          |
...
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --reference-doc my.docx          | ::: {#cb168 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | reference-doc: my.docx            |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --epub-cover-image cover.jpg     | ::: {#cb170 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | epub-cover-image: cover.jpg       |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --epub-title-page=false          | ::: {#cb172 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | epub-title-page: false            |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --epub-metadata meta.xml         | ::: {#cb174 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | epub-metadata: meta.xml           |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --epub-embed-font special.otf \  | ::: {#cb176 .sourceCode}          |
...
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --split-level 2                  | ::: {#cb178 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | split-level: 2                    |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --chunk-template="%i.html"       | ::: {#cb180 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | chunk-template: "%i.html"         |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --epub-subdirectory=""           | ::: {#cb182 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | epub-subdirectory: ''             |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --ipynb-output best              | ::: {#cb184 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | ipynb-output: best                |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --pdf-engine xelatex             | ::: {#cb186 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | pdf-engine: xelatex               |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --pdf-engine-opt=--shell-escape  | ::: {#cb188 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | pdf-engine-opts:                  |
|                                      |   - '-shell-escape'               |
|                                      | ```                               |
...
| command line                         | defaults file                     |
+:=====================================+:==================================+
|     --citeproc                       | ::: {#cb191 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | citeproc: true                    |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --bibliography logic.bib         | ::: {#cb193 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | bibliography: logic.bib           |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --csl ieee.csl                   | ::: {#cb195 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | csl: ieee.csl                     |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --citation-abbreviations ab.json | ::: {#cb197 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | citation-abbreviations: ab.json   |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --natbib                         | ::: {#cb199 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
|                                      | cite-method: natbib               |
|                                      | ```                               |
|                                      | :::                               |
+--------------------------------------+-----------------------------------+
|     --biblatex                       | ::: {#cb201 .sourceCode}          |
|                                      | ``` {.sourceCode .yaml}           |
...
| command line                    | defaults file                     |
+:================================+:==================================+
|     --dump-args                 | ::: {#cb213 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | dump-args: true                   |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --ignore-args               | ::: {#cb215 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | ignore-args: true                 |
|                                 | ```                               |
|                                 | :::                               |
